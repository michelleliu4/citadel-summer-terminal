...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_defences(self, game_state):
        ...
        wall_locations = [[0, 13], [1, 13], [26, 13], [27, 13], [5, 12], [22, 12], [9, 11], [18, 11], [12, 10], [15, 10]]
        turret_locations = [[1, 12], [26, 12], [5, 11], [22, 11], [9, 10], [18, 10], [12, 9], [15, 9]]
        support_locations = [[13, 3], [14, 3], [13, 2], [14, 2]]

        game_state.attempt_spawn(WALL, wall_locations)    
        game_state.attempt_spawn(TURRET, turret_locations)

        wall_upgradable = [[0, 13], [1, 13], [26, 13], [27, 13], [5, 12], [22, 12], [9, 11], [18, 11], [12, 10], [15, 10]]
